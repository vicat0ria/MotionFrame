    ...
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: '#2c223e' }}>
      <div className="flex-1 flex flex-col items-center px-4">
        ...
        <div className="flex-1 flex items-center justify-center w-full py-4">
          {/* Main Container */}
          <div className="w-full max-w-5xl mx-auto" style={{ backgroundColor: '#20192d', borderRadius: '0.5rem' }}>
            <div className="flex flex-col lg:flex-row py-16">
              ...
              <div className="lg:w-1/2 px-4 lg:px-8 flex flex-col justify-center">
                <div className="w-full space-y-6">
                  <div className="space-y-2">
                    <h1 className="text-2xl lg:text-3xl font-semibold tracking-tight">Welcome back</h1>
